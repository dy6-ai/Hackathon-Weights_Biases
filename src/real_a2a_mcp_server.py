...
from src.real_a2a_sdk import A2AServer, ToolCall
from src.real_a2a_agents import MathAgent, WeatherAgent, TranslationAgent, MaliciousAgent
...
class RealA2AMCPServer:
    ...
    def __init__(self):
        ...
        self._register_real_a2a_agents()
        
        logger.info("Real A2A MCP Server initialized")
    
    def _register_real_a2a_agents(self):
